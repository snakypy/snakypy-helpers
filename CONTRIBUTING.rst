...
1. Fork the `snakypy-helpers` repo on GitHub.
...
3. The pull request should work for Python 3.5, 3.6, 3.7 3.8 and 3.9, and for PyPy. Check
        ...
        https://github.com/snakypy/snakypy-helpers/actions

        https://travis-ci.com/snakypy/snakypy-helpers
